...
| Skill | Category | Does |
|---|---|---|
| [`karavi-powershell-session`](./karavi-powershell-session/) | Operator session | Supervised PowerShell: interactive user login, read-only auto-run, mutation approval, monitoring. |
...
- **Supervised PowerShell / SSH then agent commands?** → `/karavi-powershell-session`
