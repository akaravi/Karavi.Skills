# karavi-powershell-session.open-interactive.ps1
...
Write-Host '=== karavi-powershell-session: interactive login ===' -ForegroundColor Cyan
...
$meta = @{
    ...
    skill         = 'karavi-powershell-session'
}
