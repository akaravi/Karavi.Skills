...
1. Agent runs `karavi-powershell-session.agent-sanity.ps1` (read-only).
2. User or approved mutation runs `karavi-powershell-session.open-interactive.ps1` with **user-supplied** host/port/user, or a **repo-local** wrapper script.
